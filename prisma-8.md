...
Your data contract is the heart of your application. It lives at [`backend/prisma/schema.prisma`](backend/prisma/schema.prisma) and describes your models:
...
| File | Purpose |
|---|---|
| [`backend/prisma/schema.prisma`](backend/prisma/schema.prisma) | Your data contract — define your models here |
| [`prisma.config.ts`](prisma.config.ts) | CLI configuration |
| [`backend/prisma/db.ts`](backend/prisma/db.ts) | Database client — `import { db } from './backend/prisma/db'` |
| `backend/prisma/contract.json` | Compiled contract (generated) |
| `backend/prisma/contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit [`backend/prisma/schema.prisma`](backend/prisma/schema.prisma) to add or change models.
